...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    setLoading(true)
    emailjs.send('service_q5646cu', 'template_b9i32pi',
    {
      from_name: form.name,
      to_name: 'Hassan Azhar',
      from_email: form.email,
      to_email: 'hassanazhar173732@gmail.com',
      ...
      className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        >
          <label className="flex flex-col">
            ...
            text-white rounded-lg outlinedd-none border-none font-medium"
            />
